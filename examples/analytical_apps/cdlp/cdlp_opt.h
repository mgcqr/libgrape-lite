...
class CDLPOpt : public ParallelAppBase<FRAG_T, CDLPOptContext<FRAG_T, LABEL_T>,
 ...
 public:
  ...
  using worker_t = ParallelWorkerOpt<CDLPOpt<fragment_t, label_t>>;
  ...
  static std::shared_ptr<worker_t> CreateWorker(
      std::shared_ptr<CDLPOpt<FRAG_T, LABEL_T>> app,
