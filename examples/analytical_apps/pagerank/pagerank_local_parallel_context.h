...
#ifndef EXAMPLES_ANALYTICAL_APPS_PAGERANK_PAGERANK_LOCAL_PARALLEL_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_PAGERANK_PAGERANK_LOCAL_PARALLEL_CONTEXT_H_
...
class PageRankLocalParallelContext : public VertexDataContext<FRAG_T, double> {
...
#endif  // EXAMPLES_ANALYTICAL_APPS_PAGERANK_PAGERANK_LOCAL_PARALLEL_CONTEXT_H_
