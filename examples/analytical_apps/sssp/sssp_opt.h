...
#ifndef EXAMPLES_ANALYTICAL_APPS_SSSP_SSSP_OPT_H_
#define EXAMPLES_ANALYTICAL_APPS_SSSP_SSSP_OPT_H_

#include <grape/grape.h>

#include "sssp/sssp_opt_context.h"
...
class SSSPOpt : public ParallelAppBase<FRAG_T, SSSPOptContext<FRAG_T>,
                                       ParallelMessageManagerOpt>,
                public ParallelEngine {
 public:
  // specialize the templated worker.
  INSTALL_PARALLEL_OPT_WORKER(SSSPOpt<FRAG_T>, SSSPOptContext<FRAG_T>, FRAG_T)
...
#endif  // EXAMPLES_ANALYTICAL_APPS_SSSP_SSSP_OPT_H_
